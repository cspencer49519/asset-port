...
**Tested stack:** TCG Card Shop Simulator **0.70.3** + Genobear Real TCG Overhaul + **TCGShopExpansionMod0703Patch 1.2.4**.
...
| Zip | Contents |
|-----|----------|
| **TCG-0703-Genobear-1.2.4.zip** | Full: patch + `assets/` + scripts + docs |
...
7. Download and extract **TCG-0703-Genobear-1.2.4.zip** anywhere (e.g. `Downloads/TCG-0703-Genobear-1.2.4`).
...
cd "D:\Downloads\TCG-0703-Genobear-1.2.4"
...
```bat
cd /d D:\Downloads\TCG-0703-Genobear-1.2.4
...
```bash
cd ~/Downloads/TCG-0703-Genobear-1.2.4
chmod +x scripts/*.sh
...
Release notes: [release-notes/v1.2.4.md](release-notes/v1.2.4.md).

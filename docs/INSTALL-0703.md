...
**Tested stack:** TCG Card Shop Simulator **0.70.3** + Genobear Real TCG Overhaul + **TCGShopExpansionMod0703Patch 1.2.2**.
...
| Zip | Contents |
|-----|----------|
| **TCG-0703-Genobear-1.2.2.zip** | Full: patch + `assets/` + scripts + docs |
| **TCG-0703-Genobear-1.2.2-patch-only.zip** | Patch DLL + scripts + docs (no sharedassets) |
...
7. Download and extract **TCG-0703-Genobear-1.2.2.zip** anywhere (e.g. `Downloads/TCG-0703-Genobear-1.2.2`).
...
Release notes: [release-notes/v1.2.2.md](release-notes/v1.2.2.md).

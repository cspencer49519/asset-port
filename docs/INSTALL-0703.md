...
**Tested stack:** TCG Card Shop Simulator **0.70.3** + Genobear Real TCG Overhaul + **TCGShopExpansionMod0703Patch 1.2.10**.
...
| Zip | Contents |
|-----|----------|
| **TCG-0703-Genobear-1.2.10.zip** | Full: patch + `assets/` + scripts + docs |
| **TCG-0703-Genobear-1.2.10-patch-only.zip** | Patch DLL + scripts + docs (no sharedassets) |
...
7. Download and extract **TCG-0703-Genobear-1.2.10.zip** anywhere (e.g. `Downloads/TCG-0703-Genobear-1.2.10`).
...
cd "D:\Downloads\TCG-0703-Genobear-1.2.10"
...
```bat
cd /d D:\Downloads\TCG-0703-Genobear-1.2.10
...
```bash
cd ~/Downloads/TCG-0703-Genobear-1.2.10
chmod +x scripts/*.sh
...
Release notes: [release-notes/v1.2.10.md](release-notes/v1.2.10.md).

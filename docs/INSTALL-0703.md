...
**Tested stack:** TCG Card Shop Simulator **0.70.3** + Genobear Real TCG Overhaul + **TCGShopExpansionMod0703Patch 1.2.3**.
...
| Zip | Contents |
|-----|----------|
| **TCG-0703-Genobear-1.2.3.zip** | Full: patch + `assets/` + scripts + docs |
| **TCG-0703-Genobear-1.2.3-patch-only.zip** | Patch DLL + scripts + docs (no sharedassets) |
...
7. Download and extract **TCG-0703-Genobear-1.2.3.zip** anywhere (e.g. `Downloads/TCG-0703-Genobear-1.2.3`).
...
Release notes: [release-notes/v1.2.3.md](release-notes/v1.2.3.md).

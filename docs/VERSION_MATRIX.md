...
| **TCGShopExpansionMod0703Patch** | **1.2.8** | This repo — graded Destiny/Trainer/Ghost slabs, album/binder unpatch, HandleCards skip; Thunderstore package on release |
...
- [ ] Log shows `0703 Patch` **1.2.8**, album/binder unpatched, and Genobear ArtExpander 3.4.3 (GhostCardPatch warning OK)

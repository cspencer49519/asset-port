...
| **TCGShopExpansionMod0703Patch** | **1.2.3** | This repo — graded Destiny/Trainer/Ghost slabs, album/binder unpatch, HandleCards skip; Thunderstore package on release |
...
- Graded Destiny/Trainer/Ghost album slabs empty / wrong size — fixed by **0703 Patch 1.2.3** (portrait GradedCardCase + GradedFace UI slab)
...
- [ ] Log shows `0703 Patch` **1.2.3**, album/binder unpatched, and Genobear ArtExpander 3.4.3 (GhostCardPatch warning OK)

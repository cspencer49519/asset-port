...
Unzip **TCG-0703-Genobear-1.2.8** anywhere (e.g. Downloads). You should see:

```
TCG-0703-Genobear-1.2.8/
...
| [release-notes/v1.2.8.md](release-notes/v1.2.8.md) | What changed in this release |

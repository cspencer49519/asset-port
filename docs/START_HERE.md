...
Unzip **TCG-0703-Genobear-1.2.9** anywhere (e.g. Downloads). You should see:

```
TCG-0703-Genobear-1.2.9/
...
| [release-notes/v1.2.9.md](release-notes/v1.2.9.md) | What changed in this release |

...
Unzip **TCG-0703-Genobear-1.1.098** anywhere (e.g. Downloads). You should see:

```
TCG-0703-Genobear-1.1.098/
...
| [release-notes/v1.1.098.md](release-notes/v1.1.098.md) | What changed in this release |

...
Unzip **TCG-0703-Genobear-1.2.6** anywhere (e.g. Downloads). You should see:

```
TCG-0703-Genobear-1.2.6/
...
| [release-notes/v1.2.6.md](release-notes/v1.2.6.md) | What changed in this release |

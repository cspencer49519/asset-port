...
Unzip **TCG-0703-Genobear-1.2.10** anywhere (e.g. Downloads). You should see:

```
TCG-0703-Genobear-1.2.10/
...
| [release-notes/v1.2.10.md](release-notes/v1.2.10.md) | What changed in this release |

...
Unzip **TCG-0703-Genobear-1.2.4** anywhere (e.g. Downloads). You should see:

```
TCG-0703-Genobear-1.2.4/
...
| [release-notes/v1.2.4.md](release-notes/v1.2.4.md) | What changed in this release |

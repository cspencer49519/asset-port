...
3. **[docs/release-notes/v1.2.2.md](docs/release-notes/v1.2.2.md)** — what’s new
...
| Path | Purpose |
|------|---------|
| `TCGShopExpansionMod0703Patch/` | BepInEx Harmony patch (**1.2.2**) — ExpansionMod + graded slabs + pack/display fixes on 0.70.3 |
...
Upload creates GitLab release **v1.2.2** with full, patch-only, and Thunderstore zips. See [DEVELOPERS.md](docs/DEVELOPERS.md).

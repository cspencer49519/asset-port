...
3. **[docs/release-notes/v1.2.10.md](docs/release-notes/v1.2.10.md)** — what’s new
...
| Path | Purpose |
|------|---------|
| `TCGShopExpansionMod0703Patch/` | BepInEx Harmony patch (**1.2.10**) — ExpansionMod + graded slabs + pack/display fixes on 0.70.3 |
...
Upload creates GitLab release **v1.2.10** with full, patch-only, Thunderstore, and Nexus zips. See [DEVELOPERS.md](docs/DEVELOPERS.md) and [`nexus/NEXUS_PAGE.md`](nexus/NEXUS_PAGE.md).
...
- Add Thunderstore [`CHANGELOG.md`](thunderstore/CHANGELOG.md) using the [Thunderstore changelog format](https://wiki.thunderstore.io/mods/updating-a-package#changelog)

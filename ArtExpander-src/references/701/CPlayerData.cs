...
public class CPlayerData : CSingleton<CPlayerData>
{
	...
	public static List<CardItemCombiShelfSaveData> m_CardItemCombiShelfSaveDataList = new List<CardItemCombiShelfSaveData>();
	...
	public static TournamentData m_TournamentData = new TournamentData();
	...
	public static int m_DonationQuickFillMinimumCardLimit = 4;

	public static float m_DonationQuickFillPriceLimit = 1f;

	public static float m_DonationQuickFillPriceMinimum = 0.01f;

	public static ERarity m_DonationQuickFillRarityLimit = ERarity.None;

	public static ECardExpansionType m_DonationQuickFillCardExpansionType = ECardExpansionType.Tetramon;
	...
	public static void CreateDefaultData(bool isRebornReset = false)
	{
		...
		m_CardItemCombiShelfSaveDataList.Clear();
		...
		m_TournamentData = new TournamentData();
		for (int num7 = 0; num7 < 4; num7++)
		{
			TournamentPrizeDataList tournamentPrizeDataList = new TournamentPrizeDataList();
			tournamentPrizeDataList.m_PrizeDataList = new List<TournamentPrizeData>();
			m_TournamentData.m_PrizeDataList.Add(tournamentPrizeDataList);
		}
	...
	public static void AddSpecialEventCard(EMonsterType monsterType)
	{
		...
		{
			Debug.LogError((object)"monstertype should be negative for special event");
		}
		else
		{
			m_ChampionCardCollectedList.Add((int)monsterType);

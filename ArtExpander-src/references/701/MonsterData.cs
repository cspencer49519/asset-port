...
public class MonsterData
{
	...
	public List<string> ArtistNameList;
	...
	public string GetArtistNameFromList(int index)
	{
		if (index > 0 && ArtistNameList.Count > index)
		{
			return "Illus. " + ArtistNameList[index];
		}
		return "";
	}
	...
	public Sprite GetIconFromList(int index)
	{
		if (index > 0 && IconList.Count > index)
		{
	...
	public Sprite GetBGFromList(int index)
	{
		if (index > 0 && BGList.Count > index)
		{
			return BGList[index];
		}
		return null;

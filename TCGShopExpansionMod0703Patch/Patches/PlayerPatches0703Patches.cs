...
internal static class PlayerPatches0703Patches
{
    ...
    /// <summary>
    /// Skip ExpansionMod's SetCardUI postfix on 0.70.3 — SetCardExtrasImages is disabled so
    ...
    /// <summary>
    /// ExpansionMod InitOpenSequence_Postfix calls Count() on m_Card3dUIList before cards exist — freezes pack open on 0.70.3.
    /// Pack backs are handled by ExtrasHandler0703Patches + TetramonOverlay0703Patches instead.
    /// </summary>
    ...
    /// <summary>
    /// Sort-album postfix NREs on 0.70.3 — removed via Harmony.Unpatch instead.
    /// </summary>

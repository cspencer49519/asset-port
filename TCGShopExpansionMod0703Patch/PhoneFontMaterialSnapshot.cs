...
internal static class PhoneFontMaterialSnapshot
{
    ...
    public static void RestoreSharedFontMaterial(TMP_FontAsset font)
    {
        ...
        // Keep shared font at the default Transparent queue so non-phone HUD (cash register) stays visible.
        restored.renderQueue = 3000;
    }

    /// <summary>Per-label HUD material from snapshot — never bumps renderQueue to phone UI 3005.</summary>
    public static Material CreateHudLabelMaterial(TMP_FontAsset font)
    {
        ...
        labelMaterial.renderQueue = 3000;

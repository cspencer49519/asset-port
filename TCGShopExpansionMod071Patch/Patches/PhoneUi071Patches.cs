...
using HarmonyLib;
using I2.Loc;
using TCGShopExpansionMod071Patch;
using TMPro;
using UnityEngine;
...
/// <summary>
/// Restores readable phone / shop-app UI text after TextureReplacer and ExpansionMod interactions on 0.71.
/// </summary>
internal static class PhoneUi071Patches
{
    ...
    private static bool RepairPhoneWorldLabel(TextMeshProUGUI label, bool skipScopeCheck = false)
    {
        ...
        if (phoneFont != null)
        {
            PhoneFontMaterialSnapshot.RestoreSharedFontMaterial(phoneFont);

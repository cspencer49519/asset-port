...
set "PLUGIN_DIR=%GAME_ROOT%\BepInEx\plugins\TCGShopExpansionMod0703Patch"
set "PLUGIN_DLL=%PLUGIN_DIR%\TCGShopExpansionMod0703Patch.dll"
...
echo   2. Run: scripts\Verify-TCG0703Install.bat "%GAME_ROOT%"
...
echo ERROR: Python not found. Install Python or use Install-TCG0703Mods.ps1 instead.
exit /b 1
...
:resolve_patch_dll
set "PATCH_DLL=%RELEASE_ROOT%\patches\TCGShopExpansionMod0703Patch.dll"
if exist "%PATCH_DLL%" exit /b 0
set "PATCH_DLL=%RELEASE_ROOT%\TCGShopExpansionMod0703Patch\bin\Release\netstandard2.1\TCGShopExpansionMod0703Patch.dll"
if exist "%PATCH_DLL%" (
